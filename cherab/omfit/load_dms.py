    ...
    for i, f in enumerate(fib):
        ...
        if config['dms']['los_profiles']:
            ...
            for j,t in enumerate(dist_var):
                ...
                nN_los[j,f,0] = n0.distribution.density(x, y, z)
                nN_los[j,f,1] = n1.distribution.density(x, y, z)
                nN_los[j,f,2] = n2.distribution.density(x, y, z)
                nN_los[j,f,3] = n3.distribution.density(x, y, z)
                nN_los[j,f,4] = n4.distribution.density(x, y, z)
                nN_los[j,f,5] = n5.distribution.density(x, y, z)
                nN_los[j,f,6] = n6.distribution.density(x, y, z)
                nN_los[j,f,7] = n7.distribution.density(x, y, z)
                d_los[j,f]  = t
        else:
            d_los[:,f]  = None
            te_los[:,f] = None
